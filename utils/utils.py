...
extra_lip_label_colours = [(0, 0, 0),  # 0=Background
                     (0, 85, 0),   # 1=Glove
                     (255, 255, 255),  # 2=UpperClothes
                     (85, 85, 0),  # 3=Socks
                     (0, 85, 85),  # 4=Pants
                     (0, 128, 0),  # 5=Skirt
                     (51, 170, 221),  # 6=LeftArm
...
def decode_labels(mask, num_images=1, num_classes=20, extra_param=False):
    ...
    label_colours = []
    if extra_param == True:
        label_colours = extra_lip_label_colours
    elif num_classes == 20:
